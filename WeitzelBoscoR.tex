...
A timeline of the Glidein Bosco submission are shown in Figure \ref{fig:glideinsubmit}.  As you can see, there is no remote in this graph.  The jobs are not directly submitted to the remote cluster.  Rather, the pilots are directly submitted to the remote SLURM scheduler.  You can see a steady stream of jobs starting.

Comparing the Direct submission to the glidein submission.
